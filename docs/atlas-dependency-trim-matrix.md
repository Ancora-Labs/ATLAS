...
| `src/core/jesus_supervisor.ts` | Move after split | Strategic decision layer still useful, but any BOX-self signals should be removed. |
...
- Jesus -> Prometheus -> Athena -> worker loop
